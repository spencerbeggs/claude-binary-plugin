...
const testSchema = Schema.Struct({
	VERBOSE: Schema.optionalWith(Schema.String, { default: () => "false" }),
	API_KEY: Schema.optional(Schema.String),
});

type TestOptions = Schema.Schema.Type<typeof testSchema>;
...
describe("TestFixtures class", () => {
	test("TestFixtures has I/O methods", async () => {
		const { TestFixtures } = await import("../../src/testing/mocks.js");
